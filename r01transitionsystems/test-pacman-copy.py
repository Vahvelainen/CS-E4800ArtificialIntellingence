...
GRID3 = PacManGrid([".......",
                    ...
                    ".XX.XX.",
                    "......."])
ISTATE3 = PacManState(3,2,"N",GRID3)

# Generate all reachable states
breadthFirstSearch(ISTATE3,lambda state: False)

# Back to 0,0 but not facing North
breadthFirstSearch(ISTATE3,lambda state: (state.x == 0) and (state.y == 4) and (state.d != "N"))